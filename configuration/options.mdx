...
<ParamField body="dynamicInstrumentation" type="object">
...
<ParamField body="runtimeMetricsRuntimeId" type="boolean" default="false">
  Whether to add an auto-generated `runtime-id` tag to runtime metrics. Useful for correlating metrics from the same process instance.
...
<ParamField body="dbm" type="object">
